...
CREATE TABLE crawled_sites (
    ...
    devtools_payload JSONB DEFAULT '{}'::jsonb,
    resource_summary JSONB DEFAULT '[]'::jsonb,
    schema_candidates JSONB DEFAULT '[]'::jsonb,
    extraction_status VARCHAR(50) DEFAULT 'raw',
    seo_stat_metrics JSONB DEFAULT '{}'::jsonb,
    seo_feature_vector DOUBLE PRECISION[] DEFAULT '{}'::double precision[],
    seo_feature_names TEXT[] DEFAULT '{}'::text[],
    seo_feature_version TEXT,
    seo_quality_score DECIMAL(5,2),
