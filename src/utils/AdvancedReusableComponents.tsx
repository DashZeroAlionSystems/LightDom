...
const Typography = {
  Title: ({ level, children, className }: { level: number; children: ReactNode; className?: string }) => {
  ...
  const getVariantClasses = () => {
    const variants = {
      filled: {
        ...
        error: 'bg-red-600 hover:bg-red-700 text-white shadow-lg hover:shadow-xl focus:ring-red-500',
      ...
      outlined: {
        ...
        error: 'border-2 border-red-600 text-red-600 hover:bg-red-600 hover:text-white focus:ring-red-500',
...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const displayContent = maxCount && typeof content === 'number' && content > maxCount
    ? `${maxCount}+`
    : content;
...
export const Input: React.FC<InputProps> = ({
  ...
  const getInputClasses = () => {
    let baseClasses = 'w-full bg-transparent placeholder:text-gray-500 focus:outline-none transition-colors duration-200';
...
export const Select: React.FC<SelectProps> = ({
  ...
  const getSelectClasses = () => {
    let baseClasses = 'w-full bg-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none cursor-pointer transition-colors duration-200';
