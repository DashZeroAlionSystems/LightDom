 ...
 * Design Tokens
 * 
 * Centralized design system tokens for colors, spacing, typography, shadows, and more.
...
export const designTokens = {
  ...
  // Animation Easings (anime.js compatible)
  easing: {
    linear: 'linear',
...
export const getSpacing = (size: keyof SpacingScale) => {
  return designTokens.spacing[size];
};

export const getShadow = (size: keyof typeof designTokens.boxShadow) => {
