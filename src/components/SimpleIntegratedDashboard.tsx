/**
 * Simple Integrated Dashboard - Working Version
 * Basic dashboard with core functionality to test the integration
 */
...
const SimpleIntegratedDashboard: React.FC = () => {
                  ...
                  description={
                    <Space>
                      <Tag color={item.rarity === 'Legendary' ? Colors.warning : 
                                 item.rarity === 'Epic' ? Colors.info : Colors.primary}>
                        {item.rarity}
                      </Tag>
        ...
        >
          <Space direction="vertical" style={{ width: '100%' }} size={Spacing.md}>
            <div>
              ...
              <Progress percent={mockData.system.cpu} strokeColor={Colors.primary} />
            </div>
            <div>
              <Text strong style={{ color: Colors.text }}>Memory Usage</Text>
              <Progress percent={mockData.system.memory} strokeColor={Colors.warning} />
            </div>
            <div>
              <Text strong style={{ color: Colors.text }}>GPU Usage</Text>
              <Progress percent={92} strokeColor={Colors.success} />
            </div>
            <div>
              <Text strong style={{ color: Colors.text }}>Disk Usage</Text>
              <Progress percent={mockData.system.disk} strokeColor={Colors.error} />
            </div>
          </Space>
        </Card>
      </Col>
...
export default SimpleIntegratedDashboard;
