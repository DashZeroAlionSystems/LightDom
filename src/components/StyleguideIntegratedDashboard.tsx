/**
 * Styleguide Integrated Dashboard - Complete Working Version
 * Beautiful dashboard with all components integrated inline
 * Following the professional design system we established
 */
...
const StyleguideIntegratedDashboard: React.FC = () => {
  ...
  useEffect(() => {
    document.title = 'Styleguide Dashboard';
    console.log('Rendering: StyleguideIntegratedDashboard');
  }, []);
    ...
    <Row gutter={[Spacing.lg, Spacing.lg]}>
      <Col xs={24} lg={16}>
        <Card
          title={
            <Space>
              <ApiOutlined style={{ color: Colors.error }} />
...
export default StyleguideIntegratedDashboard;
