...
const AdminOverview: React.FC = () => {
  ...
  const userStatusData = [
    ...
    {
      type: 'Inactive',
      value: userStats.totalUsers - userStats.activeUsers - userStats.suspendedUsers,
    },
  ...
  const getMetricStatus = (status: string) => {
    switch (status) {
      ...
      case 'critical':
        return { color: '#f5222d', icon: <WarningOutlined /> };
      default:
        return { color: '#d9d9d9', icon: <InfoCircleOutlined /> };
    }
  };
  ...
  return (
    <div style={{ padding: '24px', background: '#f0f2f5', minHeight: '100vh' }}>
          ...
          <DSCard.Root variant='elevated'>
            <DSCard.Body>
              ...
              <div style={{ marginTop: '8px' }}>
                <Tag
                  color='cyan'
                  icon={userStats.userGrowthRate >= 0 ? <RiseOutlined /> : <FallOutlined />}
                >
                  {userStats.userGrowthRate >= 0 ? '+' : ''}
                  {userStats.userGrowthRate}% Growth
                </Tag>
              </div>
            </DSCard.Body>
          </DSCard.Root>
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
        <Col xs={24} lg={12}>
          <DSCard.Root>
            <DSCard.Header title='User Growth Trend' action={<LineChartOutlined />} />
            <DSCard.Body>
              <Line
                data={userGrowthData}
                xField='month'
        ...
        <Col xs={24} lg={12}>
          <DSCard.Root>
            <DSCard.Header title='User Status Distribution' action={<BarChartOutlined />} />
            <DSCard.Body>
              <Column
                data={userStatusData}
                xField='type'
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
        ...
        <Col xs={24} lg={8}>
          <DSCard.Root>
            <DSCard.Header title='Role Distribution' action={<SafetyOutlined />} />
            <DSCard.Body>
              <Pie
        ...
        <Col xs={24} lg={8}>
          <DSCard.Root>
            <DSCard.Header title='System Health' action={<DashboardOutlined />} />
            <DSCard.Body>
      ...
      {/* Quick Actions */}
      <DSCard.Root>
        <DSCard.Header title='Quick Actions' action={<SettingOutlined />} />
        <DSCard.Body>
          <Row gutter={[16, 16]}>
            <Col xs={24} sm={12} md={6}>
              <Button
