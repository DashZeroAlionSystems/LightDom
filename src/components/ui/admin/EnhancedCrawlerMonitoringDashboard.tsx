...
import { Activity, Cpu, Globe, RefreshCw, Zap } from 'lucide-react';
  ...
  const fetchCrawlerData = async () => {
    try {
      ...
      setStats({
        ...
        averageEfficiency:
          transformedCrawlers.length > 0
            ? transformedCrawlers.reduce((sum, c) => sum + c.efficiency, 0) /
              transformedCrawlers.length
            : 0,
      });
    } catch (error) {
    ...
    <div className='space-y-6 p-6'>
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center gap-3'>
          ...
          />
          <Button variant='outlined' size='sm' onClick={() => setAutoRefresh(!autoRefresh)}>
