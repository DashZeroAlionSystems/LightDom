...
const SettingsOverview: React.FC<SettingsOverviewProps> = ({ className }) => {
  ...
  if (loading || !settings) {
    return (
      <DSCard.Root className={className}>
        <DSCard.Body>
    ...
    <div className={className}>
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} sm={12} md={8} lg={6}>
          <DSCard.Root className='settings-overview-card'>
            <DSCard.Body>
              <Statistic
                title='Environment'
              ...
              <div style={{ marginTop: '8px', fontSize: '12px', color: '#666' }}>
                <Space direction='vertical' size='small'>
                  ...
                  <div>
                    ...
                    {getStatusIcon(settings.general.enableRegistration)}
                  </div>
                </Space>
              </div>
            </DSCard.Body>
              ...
              <div style={{ marginTop: '8px' }}>
                <Space direction='vertical' size='small'>
                  <div>
                    ...
                    {getStatusIcon(settings.performance.cacheEnabled)}
                  </div>
                  <div>
                    <Text type='secondary'>Compression:</Text>{' '}
                    {getStatusIcon(settings.performance.enableCompression)}
                  </div>
                  <div>
                    <Text type='secondary'>CDN:</Text>{' '}
                    {getStatusIcon(settings.performance.enableCDN)}
                  </div>
                </Space>
              </div>
            </DSCard.Body>
          ...
          <DSCard.Root className='settings-overview-card'>
            <DSCard.Body>
              ...
              <div style={{ marginTop: '8px', fontSize: '12px', color: '#666' }}>
                <Space direction='vertical' size='small'>
                  <div>
                    <Text type='secondary'>Auto Gas:</Text>{' '}
                    {getStatusIcon(settings.blockchain.enableAutoGasEstimation)}
                  </div>
                  <div>
                    <Text type='secondary'>Mining:</Text>{' '}
                    {getStatusIcon(settings.blockchain.enableMining)}
                  </div>
                  <div>
                    <Text type='secondary'>Events:</Text>{' '}
                    {getStatusIcon(settings.blockchain.enableEventLogging)}
                  </div>
                </Space>
              </div>
            </DSCard.Body>
          ...
          <DSCard.Root className='settings-overview-card'>
            <DSCard.Body>
              ...
              <div style={{ marginTop: '8px' }}>
                <Space direction='vertical' size='small'>
                  <div>
                    <Text type='secondary'>CORS:</Text>{' '}
                    {getStatusIcon(settings.security.enableCORS)}
                  </div>
                  <div>
                    <Text type='secondary'>Rate Limit:</Text>{' '}
                    {getStatusIcon(settings.security.enableRateLimiting)}
                  </div>
                  <div>
                    <Text type='secondary'>2FA:</Text>{' '}
                    {getStatusIcon(settings.security.enableTwoFactorAuth)}
                  </div>
                </Space>
              </div>
            </DSCard.Body>
          ...
          <DSCard.Root className='settings-overview-card'>
            <DSCard.Body>
              ...
              <div style={{ marginTop: '8px' }}>
                <Space direction='vertical' size='small'>
                  <div>
                    <Text type='secondary'>Swagger:</Text>{' '}
                    {getStatusIcon(settings.api.enableSwagger)}
                  </div>
                  <div>
                    <Text type='secondary'>GraphQL:</Text>{' '}
                    {getStatusIcon(settings.api.enableGraphQL)}
                  </div>
                  <div>
                    <Text type='secondary'>WebSocket:</Text>{' '}
                    {getStatusIcon(settings.api.enableWebSocket)}
                  </div>
                </Space>
              </div>
            </DSCard.Body>
              ...
              <div style={{ marginTop: '8px', fontSize: '12px', color: '#666' }}>
                <Space direction='vertical' size='small'>
                  <div>
                    ...
                    {getStatusIcon(settings.ui.enableAnimations)}
                  </div>
                  <div>
                    <Text type='secondary'>Tooltips:</Text>{' '}
                    {getStatusIcon(settings.ui.enableTooltips)}
                  </div>
                  <div>
                    <Text type='secondary'>Notifications:</Text>{' '}
                    {getStatusIcon(settings.ui.enableNotifications)}
                  </div>
                </Space>
              </div>
            </DSCard.Body>
            ...
            <DSCard.Body>
              ...
              <div style={{ marginTop: '8px' }}>
                <Space direction='vertical' size='small'>
                  ...
                  <div>
                    <Text type='secondary'>Backup:</Text>{' '}
                    {getStatusIcon(settings.database.enableBackup)}
                  </div>
                  <div>
                    <Text type='secondary'>Replication:</Text>{' '}
                    {getStatusIcon(settings.database.enableReplication)}
                  </div>
                </Space>
              </div>
            </DSCard.Body>
              ...
              <div style={{ marginTop: '8px' }}>
                <Space direction='vertical' size='small'>
                  ...
                  <div>
                    ...
                    {getStatusIcon(settings.email.enableAuthentication)}
                  </div>
                  <div>
                    <Text type='secondary'>Queue:</Text>{' '}
                    {getStatusIcon(settings.email.enableEmailQueue)}
                  </div>
                </Space>
              </div>
            </DSCard.Body>
              ...
              <div style={{ marginTop: '8px' }}>
                <Space direction='vertical' size='small'>
                  <div>
                    ...
                    {getStatusIcon(settings.monitoring.enableMetrics)}
                  </div>
                  <div>
                    <Text type='secondary'>Health:</Text>{' '}
                    {getStatusIcon(settings.monitoring.enableHealthChecks)}
                  </div>
                  <div>
                    <Text type='secondary'>Alerts:</Text>{' '}
                    {getStatusIcon(settings.monitoring.enableAlerting)}
                  </div>
                </Space>
              </div>
            </DSCard.Body>
