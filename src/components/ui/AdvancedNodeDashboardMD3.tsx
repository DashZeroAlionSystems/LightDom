...
const AdvancedNodeDashboardMD3: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const totalTokensEarned = sampleNodes.reduce((sum, node) => sum + node.performance.rewardsEarned, 0);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {nodes.map((node) => (
                <div 
                  ...
                  style={{ 
                    ringColor: selectedNodes.includes(node.id) ? 'var(--md-sys-color-primary)' : 'transparent'
                  }}
                  onClick={() => {
                  ...
                  <div className="md-card-content">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="md-title-medium" style={{ color: 'var(--md-sys-color-on-surface)' }}>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="md-body-medium" style={{ color: 'var(--md-sys-color-on-surface)' }}>
                          {Math.floor(node.usedStorage / 1024)}MB / {Math.floor(node.storageCapacity / 1024)}MB
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="md-body-medium" style={{ color: 'var(--md-sys-color-tertiary)' }}>
          ...
          <div className="md-card-content">
            ...
            {filteredTasks.length === 0 ? (
              <div className="text-center py-12">
                <Activity size={48} style={{ color: 'var(--md-sys-color-on-surface-variant)' }} className="mx-auto mb-4" />
                <p className="md-body-large" style={{ color: 'var(--md-sys-color-on-surface-variant)' }}>
                  ...
                  <div key={task.id} className="md-list-item">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-right">
                        <div className="md-body-medium" style={{ color: getStatusColor(task.status) }}>
