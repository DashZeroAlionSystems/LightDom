          ...
          <div className='space-y-3'>
            ...
            <div className='flex justify-between'>
              ...
              <span className='font-medium'>
                {(metrics.queue.averageProcessingTime / 1000).toFixed(1)}s
              </span>
            </div>
          </div>
        </div>
        ...
        <div className='bg-white shadow rounded-lg p-6'>
          ...
          <div className='space-y-3'>
            ...
            <div className='flex justify-between'>
              ...
              <span className='font-medium'>
                {metrics.simulation.averageEfficiency.toFixed(1)}%
              </span>
            </div>
            <div className='flex justify-between'>
              <span className='text-gray-600'>Avg Duration:</span>
              <span className='font-medium'>
                {(metrics.simulation.averageDuration / 1000).toFixed(1)}s
              </span>
            </div>
            <div className='flex justify-between'>
              ...
              <span
                className={`font-medium ${
                  metrics.simulation.networkHealthTrend === 'improving'
                    ? 'text-green-600'
                    : metrics.simulation.networkHealthTrend === 'stable'
                      ? 'text-yellow-600'
                      : 'text-red-600'
                }`}
              >
          ...
          <div>
            ...
            <div className='space-y-1'>
              <div className='flex justify-between text-sm'>
                ...
                <span className='font-medium'>
                  {(metrics.performance.memoryUsage.heapUsed / 1024 / 1024).toFixed(1)} MB
                </span>
              </div>
              <div className='flex justify-between text-sm'>
                <span className='text-gray-600'>Total:</span>
                <span className='font-medium'>
                  {(metrics.performance.memoryUsage.heapTotal / 1024 / 1024).toFixed(1)} MB
                </span>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className='space-y-1'>
              <div className='flex justify-between text-sm'>
                ...
                <span className='font-medium'>
                  {(metrics.performance.cpuUsage.user / 1000000).toFixed(1)}s
                </span>
              </div>
              <div className='flex justify-between text-sm'>
                <span className='text-gray-600'>System:</span>
                <span className='font-medium'>
                  {(metrics.performance.cpuUsage.system / 1000000).toFixed(1)}s
                </span>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className='space-y-1'>
              <div className='flex justify-between text-sm'>
                ...
                <span className='font-medium'>
                  {Math.floor(metrics.performance.uptime / 1000 / 60)} minutes
                </span>
              </div>
            </div>
          </div>
