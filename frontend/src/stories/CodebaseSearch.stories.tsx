 ...
 * 
 * The CodebaseSearch component can be used alongside PromptInput to provide
 * code context for AI conversations:
 * 
 * ```tsx
 * const [codeContext, setCodeContext] = useState('');
 * 
 * <CodebaseSearch 
 *   onContextRetrieved={(context) => setCodeContext(context)}
 * />
 * <PromptInput 
 *   onSend={(prompt) => {
 *     // Use codeContext with the prompt
 *     sendToAI(`Context:\n${codeContext}\n\nQuestion: ${prompt}`)
 *   }}
 * />
 * ```
...
/**
 * High precision search with higher threshold.
 * Returns fewer results with higher similarity.
 */
