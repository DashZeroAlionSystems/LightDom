        ...
        <div className='container mx-auto px-6 py-4'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mt-6'>
            <StatCard
              ...
              color='text-blue-400'
            />
            <StatCard label='Active' value={stats.active} icon={Zap} color='text-green-400' />
            <StatCard
              label='Running Now'
              value={stats.running}
              icon={Play}
        ...
        {loading ? (
          ...
          <div className='text-center py-20'>
            ...
            <p className='text-gray-500 mb-6'>
              Create your first schema-driven workflow to get started
            </p>
            <Button
              variant='filled'
              onClick={handleCreate}
    ...
    return (
      <div className='bg-[#2b2d31] border border-white/10 rounded-lg p-4 hover:border-[#5865f2]/50 transition-colors'>
        <div className='flex items-center gap-4'>
          ...
          <div className='flex items-center gap-2'>
            <Button variant='text' size='sm' onClick={onExecute} disabled={!workflow.is_active}>
    ...
    <div className='bg-[#2b2d31] border border-white/10 rounded-lg overflow-hidden hover:border-[#5865f2]/50 transition-colors'>
      <div className='p-4'>
        ...
        <div className='flex items-center gap-2 pt-3 border-t border-white/10'>
          ...
          <Button variant='outlined' size='sm' onClick={onEdit} className='text-xs'>
