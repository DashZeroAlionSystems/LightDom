...
const comprehensiveMetrics = [
  { label: 'Total Components', value: '30+', delta: 'MD3 compliant', tone: 'primary' as const, icon: <Layers className="h-4 w-4" /> },
  { label: 'AI Insights', value: '1,247', delta: '+23% this week', tone: 'success' as const, icon: <Brain className="h-4 w-4" /> },
  { label: 'Edge Regions', value: '6', delta: 'Global coverage', tone: 'warning' as const, icon: <Globe className="h-4 w-4" /> },
  { label: 'System Uptime', value: '99.9%', delta: 'Enterprise SLA', tone: 'tertiary' as const, icon: <Activity className="h-4 w-4" /> }
];
...
export const ComprehensiveSystemDemo: React.FC = () => {
  ...
  const [intelligenceLevel, setIntelligenceLevel] = useState<'basic' | 'adaptive' | 'predictive' | 'autonomous'>('adaptive');
  const [userTier, setUserTier] = useState<'starter' | 'professional' | 'enterprise'>('enterprise');

  const demos = [
    { id: 'overview', name: 'System Overview', icon: Home, description: 'Complete system status and architecture' },
    { id: 'ai-intelligence', name: 'AI Intelligence', icon: Brain, description: 'Smart components and ML integration' },
    { id: 'enterprise', name: 'Enterprise Governance', icon: Shield, description: 'Multi-tenant management and compliance' },
    { id: 'architecture', name: 'System Architecture', icon: Layers, description: 'Micro-frontends and edge computing' },
    { id: 'performance', name: 'Performance Analytics', icon: BarChart3, description: 'Real-time monitoring and insights' },
    { id: 'research', name: 'Research Automation', icon: Search, description: 'Continuous learning and discovery' },
    { id: 'workflows', name: 'Workflow Automation', icon: RefreshCw, description: 'Development process automation' }
  ];
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className={`px-3 py-1 rounded-full text-sm font-medium ${
                intelligenceLevel === 'basic' ? 'bg-outline text-on-surface' :
                intelligenceLevel === 'adaptive' ? 'bg-primary text-on-primary' :
                intelligenceLevel === 'predictive' ? 'bg-success text-on-success' :
      ...
      <main className="flex-1 p-8">
        ...
        {activeDemo === 'overview' && (
          <div className="space-y-8">
            ...
            <WorkflowPanel title="System Architecture Overview" description="Complete enterprise design system with AI/ML integration">
              <WorkflowPanelSection>
                <div className="grid gap-6 lg:grid-cols-4">
                  <div className="text-center p-6 rounded-3xl border border-primary/30 bg-primary-container/10">
                    ...
                    <div className="md3-body-medium text-on-surface-variant">30+ MD3 components with full accessibility</div>
                  </div>
                  ...
                  <div className="text-center p-6 rounded-3xl border border-success/30 bg-success-container/10">
                    ...
                    <div className="md3-body-medium text-on-surface-variant">Smart components with predictive capabilities</div>
                  </div>
                  ...
                  <div className="text-center p-6 rounded-3xl border border-warning/30 bg-warning-container/10">
                    ...
                    <div className="md3-title-medium text-on-surface mb-2">Enterprise Governance</div>
                    <div className="md3-body-medium text-on-surface-variant">Multi-tenant management and compliance</div>
                  </div>
                  ...
                  <div className="text-center p-6 rounded-3xl border border-tertiary/30 bg-tertiary-container/10">
                    ...
                    <div className="md3-body-medium text-on-surface-variant">Edge computing with 6 global regions</div>
                  </div>
                </div>
              </WorkflowPanelSection>
            </WorkflowPanel>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              ...
              <WorkflowPanel title="Enterprise Metrics" description="Organization and governance status">
                <WorkflowPanelSection>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="md3-body-medium text-on-surface-variant">Active Tenants</span>
                      <span className="md3-body-medium text-on-surface font-medium">12</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="md3-body-medium text-on-surface-variant">Compliance Score</span>
                      <span className="md3-body-medium text-success font-medium">97%</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="md3-body-medium text-on-surface-variant">Security Events</span>
              ...
              <WorkflowPanel title="Performance Stats" description="System performance and optimization">
                <WorkflowPanelSection>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
        ...
        {activeDemo === 'ai-intelligence' && (
          <div className="space-y-8">
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <WorkflowPanel title="Neural Network Training" description="Real-time ML model training and monitoring">
                <WorkflowPanelSection>
              ...
              <WorkflowPanel title="Training Analytics" description="Comprehensive model performance metrics">
                <WorkflowPanelSection>
                  <MetricsChart
                    data={trainingData}
        ...
        {activeDemo === 'architecture' && (
          <div className="space-y-8">
              ...
              <WorkflowPanelSection>
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                  <div className="text-center p-6 rounded-3xl border border-primary/30 bg-primary-container/10">
                    ...
                    <div className="md3-body-small text-on-surface-variant">Main application shell with routing</div>
                  </div>
                  <div className="text-center p-6 rounded-3xl border border-success/30 bg-success-container/10">
                    <Brain className="h-12 w-12 text-success mx-auto mb-3" />
                    <div className="md3-title-medium text-on-surface mb-2">AI/ML Engine</div>
                    <div className="md3-body-small text-on-surface-variant">Neural network processing and insights</div>
                  </div>
                  <div className="text-center p-6 rounded-3xl border border-warning/30 bg-warning-container/10">
                    ...
                    <div className="md3-body-small text-on-surface-variant">Data visualization and monitoring</div>
                  </div>
                  <div className="text-center p-6 rounded-3xl border border-tertiary/30 bg-tertiary-container/10">
                    ...
                    <div className="md3-body-small text-on-surface-variant">Enterprise governance and management</div>
                  </div>
                </div>
              </WorkflowPanelSection>
            </WorkflowPanel>
            ...
            <WorkflowPanel title="Advanced State Management" description="Sophisticated global state with offline support and AI optimization">
              <WorkflowPanelSection>
        ...
        {activeDemo === 'workflows' && (
          <div className="space-y-6">
            <WorkflowPanel title="Intelligent Workflow Orchestration" description="AI-powered automation with quality gates and continuous learning">
              <WorkflowPanelSection>
            ...
            <WorkflowPanel title="Workflow Performance Metrics" description="Real-time automation efficiency and success rates">
              <WorkflowPanelSection>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-6">
            <div className="text-center">
              ...
              <div className="md3-body-small text-on-surface-variant">Enterprise AI/ML Design System</div>
            </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="text-right">
              ...
              <div className="md3-label-medium text-on-surface font-medium capitalize">{intelligenceLevel}</div>
            </div>
            <div className="text-right">
