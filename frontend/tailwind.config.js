...
module.exports = {
  ...
  // Safelist custom design-system utility classes so Tailwind generates
  // utilities referenced via @apply in our CSS (these are dynamic
  // variables and sometimes not picked up by the content scanner).
  safelist: [
    { pattern: /^bg-/ },
    { pattern: /^text-/ },
    { pattern: /^border-/ },
